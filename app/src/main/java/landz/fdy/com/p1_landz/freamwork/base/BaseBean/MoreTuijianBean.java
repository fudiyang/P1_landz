 ...
 * Description :
 */
public class MoreTuijianBean implements Parcelable {
    ...
    public MoreTuijianBean() {
    }

    protected MoreTuijianBean(Parcel in) {
    ...
    public static final Parcelable.Creator<MoreTuijianBean> CREATOR = new Parcelable.Creator<MoreTuijianBean>() {
        @Override
        public MoreTuijianBean createFromParcel(Parcel source) {
            return new MoreTuijianBean(source);
        }

        @Override
        public MoreTuijianBean[] newArray(int size) {
            return new MoreTuijianBean[size];
        }
    };
}
