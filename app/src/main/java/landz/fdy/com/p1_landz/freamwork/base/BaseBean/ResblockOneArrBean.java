...
public class ResblockOneArrBean implements Parcelable {
    ...
    public ResblockOneArrBean() {
    }

    protected ResblockOneArrBean(Parcel in) {
    ...
    public static final Parcelable.Creator<ResblockOneArrBean> CREATOR = new Parcelable.Creator<ResblockOneArrBean>() {
        @Override
        public ResblockOneArrBean createFromParcel(Parcel source) {
            return new ResblockOneArrBean(source);
        }

        @Override
        public ResblockOneArrBean[] newArray(int size) {
            return new ResblockOneArrBean[size];
        }
    };
}
